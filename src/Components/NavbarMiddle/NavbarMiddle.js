    ...
    <div className='middle'>
      <div className='container middle__container'>
        ...
        <div className='info__wrapper'>
          <button onClick={handleListOpened} className='info__wrapper-btn'>
            +7 (920) 211-49-03
          </button>
          <div
            className={
              opened ? 'info__content info__content-opened' : 'info__content'
            }
          >
            <ul className='info__content-list'>
              <li className='info__content-item'>
                <a className='info__content-link' href='tel:+7 (920) 211-49-03'>
                  +7 (920) 211-49-03
                </a>
              </li>
              <li className='info__content-item'>
                <a
                  className='info__content-link info__content-link--year'
                  href='tel:+7 (920) 211-49-03'
                >
              ...
              <li className='info__content-item'>
                <a
                  className='info__content-link info__content-link--location'
                  href='tel:+7 (920) 211-49-03'
                >
                  ул. Вл. Невского 17
                </a>
              ...
              <li className='info__content-item'>
                <a
                  className='info__content-link info__content-link--sms'
                  href='tel:+7 (920) 211-49-03'
                >
                  info@lavkaroz.ru
                </a>
